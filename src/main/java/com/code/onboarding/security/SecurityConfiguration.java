...
import com.code.onboarding.dto.UriAccessDTO;
import com.code.onboarding.util.RolesPropertiesUtil;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
  ...
  @Autowired
  private RolesPropertiesUtil rolesPropertiesUtil;
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    rolesPropertiesUtil.getUser();
    rolesPropertiesUtil.getAdmin();
    ...
    //.antMatchers(HttpMethod.POST, "/account").permitAll()
          .antMatchers(HttpMethod.GET, "/employee/*").access("hasRole('ROLE_ADMIN')") 
